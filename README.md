...
**1. Personalized step notifications**
Send reminders when users are close to their daily goal — for example: *"You're only 1,500 steps away! A quick 15-minute walk can get you there."*

**2. Activity challenges**
Since activity doesn't naturally increase on weekends, weekly challenges and achievement badges could help keep users engaged. Sundays showed the lowest activity levels — a good target for push campaigns.

**3. Sleep coaching**
Users with low sleep efficiency could benefit from in-app recommendations: wind-down routines, breathing exercises, bedtime reminders.

**4. Wellbeing Score**
Combining step and sleep data into a single score could make progress more visible and shareable — increasing user engagement with the app.
